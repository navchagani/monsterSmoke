              ...
              child: Column(
                children: [
                  ...
                  GridView.count(
                    ...
                    mainAxisSpacing: 20,
                    children: [
                      itemDashboard('Opening Balance', '\$0.00',
                          CupertinoIcons.cube, const Color(0xff202b38)),
                      itemDashboard('Invoiced Amount', '\$783.47',
                          Icons.inventory_rounded, const Color(0xff202b38)),
                      itemDashboard('Amount Received', '\$783.47',
                          Icons.attach_money_rounded, const Color(0xff202b38)),
                      itemDashboard('Total DueBalance', '\$0.00', Icons.store,
