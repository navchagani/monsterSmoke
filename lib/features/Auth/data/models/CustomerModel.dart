class CustomerModel {
  ...
  final bool? viewSpecificProduct;
  final String? websiteReference;
  ...
  final String? salesRepresentativeEmail;
  final String? tobaccoId;
  final String? taxId;
  final bool? taxable;
  final String? feinNumber;
  final String? tobaccoLicenseExpirationDate;
  final String? tobaccoLicenseExpirationDateString;
  final String? vaporTaxId;
  final String? vaporTaxExpirationDate;
  final String? referByCustomerId;
  final bool? communicateViaPhone;
  final bool? communicateViaText;
  ...
  final String? voidCheckNumber;
  final String? drivingLicenseNumber;
  final String? customerTypeId;
  final String? customerTypeName;
  final String? preferredLanguage;
  final String? achVerified;
  final String? parentCustomerFirstName;
  final String? parentCustomerLastName;
  final String? parentCustomerCompany;
